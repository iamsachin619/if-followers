...
export default function Footer() {
  return (
    <div><footer id="footer" className="footer-area section-padding">
  <div className="container">
    <div className="container">
      <div className="row">
        <div className="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
          <div className="widget">
            <h3 className="footer-logo"><img src="assets/img/logo.png" alt /></h3>
        ...
        <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
          ...
          <ul className="address">
            <li>
              <a href="#"><i className="lni-map-marker" /> 105 Madison Avenue - <br /> Third Floor New York, NY 10016</a>
            </li>
            <li>
              <a href="#"><i className="lni-phone-handset" /> P: +84 846 250 592</a>
            </li>
            <li>
              <a href="#"><i className="lni-envelope" /> E: contact@uideck.com</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-md-12">
          <div className="copyright-content">
            <p>Copyright © 2020 <a rel="nofollow" href="">Ig-Follow</a> All Right Reserved</p>
          </div>
        </div>
      </div>
    </div>

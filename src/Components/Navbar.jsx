    ...
    <div className={`${collapseStatus?'show':''} navbar-collapse ${collapseStatus?'collapse ':'collapse '}`} id="navbarCollapse">
      <ul className="navbar-nav mr-auto w-100 justify-content-end clearfix">
        ...
        <li className="nav-item">
          <AnchorLink  className="nav-link" offset='50' href="#services">
            Services
          </AnchorLink >
        </li>
        <li className="nav-item">
          <AnchorLink  className="nav-link"  offset='50' href="#aboutUs">
            About Us
          </AnchorLink >
        </li>
        <li className="nav-item">
          <AnchorLink  className="nav-link"   offset='50' href="#pricing">
            Pricing
          </AnchorLink >
        </li>
        <li className="nav-item">
          <AnchorLink  className="nav-link"  offset='50' href="#testimonial">
            Testimonial
          </AnchorLink >
        </li>
        <li className="nav-item">
